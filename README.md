...
Projeto do curso Ignite - Trilha React da [Rocketseat](https://rocketseat.com.br/). Aplicação de listagem de repositórios do usuário, utilizando ReactJS para renderizar os itens e a API do GitHub para obter as informações.
